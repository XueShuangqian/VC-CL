...
from test_3D_util import test_all_case, test_all_case1, test_all_case2

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/home/xsq/xsq/TSS-CL/my_data/dwh/test-2', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='TSS_CL_hard_60', help='experiment_name')
...
def Inference(FLAGS):
    snapshot_path = "/home/xsq/xsq/TSS-CL/VAT_SErr/model_STT_30_70/{}/{}".format(FLAGS.exp, FLAGS.model)
    num_classes = 2
    test_save_path = "/home/xsq/xsq/TSS-CL/VAT_SErr/model_STT_30_70/{}/{}_Prediction-vnet".format(FLAGS.exp, FLAGS.model)
    ...
    #save_mode_path = os.path.join(snapshot_path, 'DV-CL.pth')
