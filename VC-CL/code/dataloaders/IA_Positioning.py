...
def CT_nifti(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        sitk.WriteImage(img_itk, '/home/xsq/xsq/data_myself/zz/Tr_img_{}.nii.gz'.format(str(idx)[:]))
        sitk.WriteImage(label_itk,
                            '/home/xsq/xsq/data_myself/zz/Tr_label_{}.nii.gz'.format(str(idx)[1:]))
...
def nifti_covert_h5(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        print('---------------')
        f = h5py.File(
                '/home/xsq/xsq/TSS-CL/my_data/dwh/98-20-LQ/Tr_{}.h5'.format(str(idx)[:]), 'w')
...
def covert_h5_3(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        print("label shape", label.shape)
        f = h5py.File(
                '/home/xsq/xsq/TSS-CL/my_data/whd/all-LQ-whd/Tr_{}.h5'.format(str(idx)[:]), 'w')
...
if __name__ == '__main__':
    img_Dir = '/home/xsq/xsq/data_myself/all_LQ_img/*.nii.gz'
    label_Dir = '/home/xsq/xsq/data_myself/all_LQ_label/'
