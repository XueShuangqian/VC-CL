...
if __name__=='__main__':
    ...
    clean_num = 15 # clean percentage: 10%, 20%, 30% (80 cases in total)
    train_list_path = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/train_h5.txt'
    test_list_path = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/3.txt'
    ori_Dir = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/3/'
    corrupt_Dir = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/data_noise_15_h5/'
    nifti_Dir = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/4/'
    if not os.path.exists(corrupt_Dir):
        os.makedirs(corrupt_Dir)
    corrupt_VIS_Dir = '/home/xsq/xsq/STT-CL/LA_set_3D/data/HQ/data_noise_VIS/'
